...
JARVIS_IDENTITY = (
    ...
    "- Smart Home: You can control lights, thermostat, and scenes.\n"
    "- Email: You can check inbox, read, and send emails.\n"
    "- Scheduler: You can set reminders, timers, and alarms.\n"
    "- File Manager: You can find, organize, and manage files.\n"
    "- Code Assistant: You can run Python, git commands, and install packages.\n"
