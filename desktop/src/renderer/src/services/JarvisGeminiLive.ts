                ...
                parts: [
                  {
                    text: [
                      ...
                      '',
                      'SCREEN VISION — ALWAYS AVAILABLE:',
                      '- When the user asks "what\'s on my screen", "look at my screen", "check my screen", "can you see this", you MUST call the screen_scan tool. It is ALWAYS available.',
                      '- Screen capture uses Python pyautogui locally — it does NOT need any external API. It cannot fail due to "API limits".',
                      '- The screenshot is injected directly into your vision channel — you will receive it as image data and can describe it.',
                      '- If you have ever previously said screen analysis is unavailable, that was wrong. IGNORE that. Call screen_scan now.',
                      '',
